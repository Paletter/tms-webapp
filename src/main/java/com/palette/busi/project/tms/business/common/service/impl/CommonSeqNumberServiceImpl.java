...
public class CommonSeqNumberServiceImpl extends BaseServiceImpl implements CommonSeqNumberService {
	...
	public String generatePiecesNo() throws BusinessException {
		return (String) baseDao.getSqlSessionTemplate().selectOne(SqlMapperConstants.BUSINESS_COMMON_QUERY_SEQ_NEXTVAL, CodeConstants.SEQUENCE_NUMBER_TYPE.PIECES_NO);
	}

	@Override
	public String generateUnitNo() throws BusinessException {
		return (String) baseDao.getSqlSessionTemplate().selectOne(SqlMapperConstants.BUSINESS_COMMON_QUERY_SEQ_NEXTVAL, CodeConstants.SEQUENCE_NUMBER_TYPE.UNIT_NO);
	}

	@Override
	public String generateSectorNo() throws BusinessException {
		return (String) baseDao.getSqlSessionTemplate().selectOne(SqlMapperConstants.BUSINESS_COMMON_QUERY_SEQ_NEXTVAL, CodeConstants.SEQUENCE_NUMBER_TYPE.SECTOR_NO);
	}
	
	@Override
	public String generateSyncTargetNo() throws BusinessException {
		String targetNo = (String) baseDao.getSqlSessionTemplate().selectOne(SqlMapperConstants.BUSINESS_COMMON_QUERY_SEQ_NEXTVAL, CodeConstants.SEQUENCE_NUMBER_TYPE.SYNC_TARGET_NO);
	...
	public String generateDeliveryOrderNo() throws BusinessException {
		return baseDao.getSqlSessionTemplate().selectOne(SqlMapperConstants.BUSINESS_COMMON_QUERY_SEQ_NEXTVAL, CodeConstants.SEQUENCE_NUMBER_TYPE.DELIVERY_ORDER_NO);
	}
